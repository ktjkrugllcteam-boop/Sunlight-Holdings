...
const translations: Record<Language, Record<string, string>> = {
  fr: {
    ...
    'portfolio.platinum.description': 'Platinum Edge représente le nouveau standard de vie résidentielle de luxe à Dakar.',
    'portfolio.platinum.overview': 'Platinum Edge représente le nouveau standard de vie résidentielle de luxe à Dakar. Située dans le prestigieux quartier des Almadies, cette résidence méticuleusement conçue met en valeur le niveau de finition et d\'attention aux détails qui définit le portfolio de Sunlight Holdings.',
    'portfolio.platinum.features': 'La propriété dispose de systèmes d\'éclairage ambiant personnalisés, de surfaces en béton poli, de luminaires importés premium et d\'art contemporain africain soigneusement sélectionné. Chaque élément a été pensé pour créer un environnement de vie rivalisant avec les plus belles résidences de toute capitale mondiale.',
  ...
  en: {
    ...
    'portfolio.platinum.description': 'Platinum Edge represents the new standard for luxury residential living in Dakar.',
    'portfolio.platinum.overview': 'Platinum Edge represents the new standard for luxury residential living in Dakar. Located in the prestigious Almadies district, this meticulously designed residence showcases the level of finish and attention to detail that defines the Sunlight Holdings portfolio.',
    'portfolio.platinum.features': 'The property features custom ambient lighting systems, polished concrete surfaces, premium imported fixtures, and curated African contemporary art. Every element has been considered to create a living environment that rivals the finest residences in any global capital.',
